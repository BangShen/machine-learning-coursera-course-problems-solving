...
* 为了避免初始化参数容易导致的对称性问题，需要随机初始化的参数值，其方法就是$$\Theta = rand(10,11) * 2 * \epsilon - \epsilon $$， 但是问题是如何确定\epsilon呢，在Andrew的课程练习中提到用的方法是\epsilon<sub>init</sub> = \cfrac{\sqrt{6}}{\sqrt{L<sub>in</sub> + L<sub>out</sub>}},
